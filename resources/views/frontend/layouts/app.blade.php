...
<head>
    ...
    <!-- Icon Font CSS -->
    <link rel="stylesheet" href="{{ static_asset('assets1/css/all.min.css') }}">
    <link rel="stylesheet" href="{{ static_asset('assets1/css/ionicons.min.css') }}">
    <link rel="stylesheet" href="{{ static_asset('assets1/css/themify-icons.css') }}">
    <link rel="stylesheet" href="{{ static_asset('assets1/css/linearicons.css') }}">
    <link rel="stylesheet" href="{{ static_asset('assets1/css/flaticon.css') }}">
    <link rel="stylesheet" href="{{ static_asset('assets1/css/simple-line-icons.css') }}">
    <!--- owl carousel CSS-->
    <link rel="stylesheet" href="{{ static_asset('assets1/owlcarousel/css/owl.carousel.min.css') }}">
    <link rel="stylesheet" href="{{ static_asset('assets1/owlcarousel/css/owl.theme.css') }}">
    <link rel="stylesheet" href="{{ static_asset('assets1/owlcarousel/css/owl.theme.default.min.css') }}">
    <!-- Magnific Popup CSS -->
    <link rel="stylesheet" href="{{ static_asset('assets1/css/magnific-popup.css') }}">
    <!-- Slick CSS -->
    <link rel="stylesheet" href="{{ static_asset('assets1/css/slick.css') }}">
    <link rel="stylesheet" href="{{ static_asset('assets1/css/slick-theme.css') }}">
    <!-- Style CSS -->
    <link rel="stylesheet" href="{{ static_asset('assets1/css/style.css') }}">
    <link rel="stylesheet" href="{{ static_asset('assets1/css/responsive.css') }}">
    ...
    <script src="{{ static_asset('assets1/bootstrap/js/bootstrap.min.js') }}"></script> 
    <!-- owl-carousel min js  --> 
    <script src="{{ static_asset('assets1/owlcarousel/js/owl.carousel.min.js') }}"></script> 
    <!-- magnific-popup min js  --> 
    <script src="{{ static_asset('assets1/js/magnific-popup.min.js') }}"></script> 
    <!-- waypoints min js  --> 
    <script src="{{ static_asset('assets1/js/waypoints.min.js') }}"></script> 
    <!-- parallax js  --> 
    <script src="{{ static_asset('assets1/js/parallax.js') }}"></script> 
    <!-- countdown js  --> 
    <script src="{{ static_asset('assets1/js/jquery.countdown.min.js') }}"></script> 
    <!-- imagesloaded js --> 
    <script src="{{ static_asset('assets1/js/imagesloaded.pkgd.min.js') }}"></script>
    <!-- isotope min js --> 
    <script src="{{ static_asset('assets1/js/isotope.min.js') }}"></script>
    <!-- jquery.dd.min js -->
    <script src="{{ static_asset('assets1/js/jquery.dd.min.js') }}"></script>
    <!-- slick js -->
    <script src="{{ static_asset('assets1/js/slick.min.js') }}"></script>
    <!-- elevatezoom js -->
    <script src="{{ static_asset('assets1/js/jquery.elevatezoom.js') }}"></script>
    <!-- scripts js --> 
    <script src="{{ static_asset('assets1/js/scripts.js') }}"></script>
