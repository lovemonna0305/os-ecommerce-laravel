            ...
            <!-- Header Logo -->
                <div class="col-auto pl-0 pr-3 d-flex align-items-center">
                    <a class="d-block py-20px mr-3 ml-0" href="{{ route('home') }}">
                        ...
                        @else
                            <img src="{{ static_asset('assets/img/logo1.png') }}" alt="{{ env('APP_NAME') }}" class="mw-100 h-30px h-md-40px" height="40">
                        @endif
                    </a>
                </div>
                ...
                <ul class="navbar-nav attr-nav align-items-center">
                    ...
                    <li>
                        <a href="javascript:void(0);" class="nav-link search_trigger"><i class="ti-bell"></i>
                            @if(Auth::check() && count(Auth::user()->unreadNotifications) > 0)
                                    <span class="cart_count">{{ count(Auth::user()->unreadNotifications) }}</span>
                                @endif
                            @auth
